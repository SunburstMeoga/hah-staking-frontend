...
module.exports = {
  ...
  // 生产环境链配置
  VUE_APP_MAINNET_CHAIN_ID: '"0x329"', // 809 (修复：使用正确的链ID)
  VUE_APP_MAINNET_RPC_URL: '"https://rpc.hashahead.org/mrpc"', // 修复：主链使用/mrpc
  VUE_APP_MAINNET_CHAIN_NAME: '"Hash Ahead Mainnet"',
  VUE_APP_MAINNET_EXPLORER_URL: '"https://scan.hashahead.org/"',

  VUE_APP_SUBCHAIN_CHAIN_ID: '"0x32A"', // 810 (修复：子链ID应该是主链ID+1)
  VUE_APP_SUBCHAIN_RPC_URL: '"https://rpc.hashahead.org"', // 修复：应用链不使用mrpc
  VUE_APP_SUBCHAIN_CHAIN_NAME: '"Hash Ahead ByteBloom"',
  VUE_APP_SUBCHAIN_EXPLORER_URL: '"https://scan.hashahead.org/"',

  // 兼容旧版本的变量名
  VUE_APP_APPCHAIN_CHAIN_ID: '"0x32A"',
